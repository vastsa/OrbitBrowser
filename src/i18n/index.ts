...
export const copy = {
  "zh-CN": {
    ...
    tasks: {
      ...
      taskList: "任务列表",
      countUnit: "个",
      searchPlaceholder: "搜索任务名称、描述或脚本",
      clearFilter: "清除过滤",
      loadFailed: "任务列表加载失败",
      emptyTitle: "暂无任务",
      ...
      validationFailed: "脚本校验未通过",
      validationPassedWithWarnings: "脚本可运行，但有优化建议",
      timeout: "超时时间",
      seconds: "秒",
      scriptLines: "脚本行数",
      runTargets: "运行目标",
      ...
      description: "描述",
      descriptionPlaceholder: "补充任务用途、站点或注意事项（可选）",
      scriptEditor: "脚本编辑器",
      scriptPlaceholder: "编写自动化脚本，例如 await page.goto(\"https://example.com\")",
      templatesLabel: "模板",
      lineCount: "{{count}} 行",
      deleteTitle: "删除任务",
      deleteTask: "删除任务",
    ...
    settings: {
      ...
      installingCamoufox: "安装中…",
      camoufoxInstallStages: {
        locating_python: "正在查找 Python",
        preparing_environment: "正在准备独立运行环境",
        updating_installer: "正在更新安装工具",
        installing_packages: "正在安装 Camoufox 依赖",
        fetching_browser: "正在下载浏览器、GeoIP 和插件",
        downloading_browser_fallback: "正在使用备用方式下载浏览器",
        verifying: "正在校验安装结果",
      },
      camoufoxPythonPath: "Camoufox Python 路径",
      validatingCamoufoxPath: "正在验证已保存的 Camoufox 路径…",
      camoufoxSavedPathInvalid:
        "已保存的 Camoufox 路径当前不可用，请重新检测或安装更新。",
    ...
    agent: {
      ...
      shortcutHint: "Enter 发送，Shift 或 Ctrl + Enter 换行",
      composerLabel: "给智能助手发送消息",
      addReference: "添加上下文引用",
      removeReference: "移除引用",
      referencePickerTitle: "添加任务、运行日志或产物作为上下文",
      referenceCount: "{{count}} 项引用",
      send: "发送",
      stop: "停止",
      ...
      recordingRequests: "请求",
      recordingResponses: "响应",
      recordingEventCount: "{{count}} 条事件",
      recordingRefresh: "刷新",
      recordingClear: "清空",
      recordingFilterAll: "全部",
      recordingFilterRequest: "请求",
      recordingFilterResponse: "响应",
      recordingFilterNavigation: "导航",
      recordingFilterPage: "页面",
      recordingFilterOther: "其他",
      recordingSearchPlaceholder: "过滤 URL / 方法 / 类型",
      recordingEmptyFilter: "没有匹配的录制事件。",
      recordingAttachAll: "引用全部",
      recordingAttachFiltered: "引用筛选结果",
      recordingAttachEvent: "引用该事件到对话",
      recordingWaiting: "录制中，等待浏览器事件…",
      noRecording: "尚未开始录制。",
  ...
  "en-US": {
    ...
    tasks: {
      ...
      taskList: "Task List",
      countUnit: "",
      searchPlaceholder: "Search task names, descriptions, or scripts",
      ...
      validationPassedWithWarnings: "Script is valid, with suggestions",
      timeout: "Timeout",
      seconds: "s",
      scriptLines: "Script Lines",
      ...
      descriptionPlaceholder: "Optional notes about purpose, site, or caveats",
      scriptEditor: "Script Editor",
      scriptPlaceholder: "Write automation script, e.g. await page.goto(\"https://example.com\")",
    ...
    settings: {
      ...
      installingCamoufox: "Installing…",
      camoufoxInstallStages: {
        locating_python: "Locating Python",
        preparing_environment: "Preparing the isolated environment",
        updating_installer: "Updating installation tools",
        installing_packages: "Installing Camoufox dependencies",
        fetching_browser: "Downloading the browser, GeoIP data, and add-ons",
        downloading_browser_fallback:
          "Downloading the browser with the fallback method",
        verifying: "Verifying the installation",
      },
      camoufoxPythonPath: "Camoufox Python Path",
      validatingCamoufoxPath: "Validating the saved Camoufox path…",
      camoufoxSavedPathInvalid:
        "The saved Camoufox path is unavailable. Detect or install it again.",
    ...
    agent: {
      ...
      shortcutHint: "Enter to send, Shift or Ctrl + Enter for a new line",
      composerLabel: "Message the AI assistant",
      addReference: "Add context reference",
      removeReference: "Remove reference",
      referencePickerTitle: "Add a task, run log, or artifact as context",
      ...
      recordingRequests: "Requests",
      recordingResponses: "Responses",
      recordingEventCount: "{{count}} events",
      recordingRefresh: "Refresh",
      recordingClear: "Clear",
      recordingFilterAll: "All",
      recordingFilterRequest: "Request",
      recordingFilterResponse: "Response",
      recordingFilterNavigation: "Navigation",
      recordingFilterPage: "Page",
      recordingFilterOther: "Other",
      recordingSearchPlaceholder: "Filter URL / method / kind",
      recordingEmptyFilter: "No matching recording events.",
      recordingAttachAll: "Attach All",
      recordingAttachFiltered: "Attach Filtered",
      recordingAttachEvent: "Attach this event to the chat",
      recordingWaiting: "Recording… waiting for browser events.",
